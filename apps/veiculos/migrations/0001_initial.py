    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custo_manutencao', models.DecimalField(decimal_places=2, default='0.00', max_digits=10, verbose_name='Custo da Manutenção')),
                ('tipo_servico_veiculo', models.CharField(choices=[('Remoção', 'Remoção'), ('Seletiva', 'Seletiva'), ('Testes', 'Teste')], default='Teste', max_length=20)),
                ('tipo_servico_usuario', models.CharField(blank=True, choices=[('Remoção', 'Remoção'), ('Seletiva', 'Seletiva'), ('Testes', 'Teste')], max_length=20, null=True, verbose_name='Tipo de Serviço Selecionado pelo Usuário')),
            ],
            options={
                'db_table': 'veiculo',
            },
